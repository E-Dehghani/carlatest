...
# %%
# with open('/home/edehghan/Data/CARLA-main/datasets/MSL_SMAP/labeled_anomalies.csv', 'r') as file:
...
# file_list = os.listdir(os.path.join('/home/edehghan/Data/CARLA-main/datasets/', 'UCR'))                        
# file_list = sorted(file_list)
...
#         subprocess.run([
#             'python', '/home/edehghan/Data/CARLA-main/Published/CARLA/carla_pretext.py',
#             '--config_env', '/home/edehghan/Data/CARLA-main/Published/CARLA/configs/env.yml',
#             '--config_exp', '/home/edehghan/Data/CARLA-main/Published/CARLA/configs/pretext/carla_pretext_smd.yml',
#             '--fname', filename
#         ])
        
#         # Run the classification script
#         subprocess.run([
#             'python', '/home/edehghan/Data/CARLA-main/Published/CARLA/carla_classification.py',
#             '--config_env', '/home/edehghan/Data/CARLA-main/Published/CARLA/configs/env.yml',
#             '--config_exp', '/home/edehghan/Data/CARLA-main/Published/CARLA/configs/classification/carla_classification_smd.yml',
#             '--fname', filename
#         ])
